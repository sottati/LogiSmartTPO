...
public class Suscripcion {
    ...
    public Suscripcion(String id, String plan, String estado,
                       double montoMensual, LocalDate proximoVencimiento) {
        this.id                 = id;
        this.plan               = plan;
        this.estado             = estado;
    ...
    public void pausar()  { estado = "PAUSADA"; }
    ...
    public void cambiarPlan(String nuevoPlan, double nuevoMonto) {
        plan         = nuevoPlan;
