...
public class EstadoRetenido implements EstadoEnvio {
    ...
    @Override public void entregar(Envio e) { System.out.println("[Estado] No se puede entregar un envío retenido."); }
    @Override public void cancelar(Envio e) { e.cambiarEstado(new EstadoCancelado()); }
    @Override public void retener(Envio e)  { System.out.println("[Estado] El envío ya está retenido."); }
    @Override public void devolver(Envio e) { e.cambiarEstado(new EstadoConfirmado()); }
    @Override public void reclamar(Envio e) { System.out.println("[Estado] Reclamo registrado para envío retenido."); }
