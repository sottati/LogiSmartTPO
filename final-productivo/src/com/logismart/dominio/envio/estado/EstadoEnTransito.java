...
public class EstadoEnTransito implements EstadoEnvio {
    @Override public void validar(Envio e)  { throw new IllegalStateException("El envío ya está en tránsito."); }
    ...
    @Override public void reclamar(Envio e) { /* reclamo válido en EN_TRANSITO — sin cambio de estado */ }
