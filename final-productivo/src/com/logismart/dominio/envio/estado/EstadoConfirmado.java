...
public class EstadoConfirmado implements EstadoEnvio {
    ...
    @Override public void entregar(Envio e) { System.out.println("[Estado] No se puede entregar un envío confirmado."); }
    ...
    @Override public void devolver(Envio e) { System.out.println("[Estado] No se puede devolver un envío confirmado."); }
    @Override public void reclamar(Envio e) { System.out.println("[Estado] No se puede reclamar un envío confirmado."); }
